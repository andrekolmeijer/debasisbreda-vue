...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        'inspire-orange': '#E4A736', // #F28C00 inspirecoffee.com / #F98A0C menukaart / #FF914D honktwee
        'inspire-orange-dark': '#14343F', // #D07418 color picker
        'inspire-brown-light': '#2A636F', // #DDC5B8 menukaart / #C49463 honktwee
        'inspire-brown': '#778158', // #C99C6C color picker
