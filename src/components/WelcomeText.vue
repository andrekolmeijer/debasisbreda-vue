<template>
  <div>
    <h1 class="w-2/3 pt-8 text-3xl font-black uppercase tracking-normal text-inspire-orange">
      Welkom bij <span class="text-inspire-orange-dark">De Basis</span>
    </h1>
    <p class="gap-8 pt-8 pb-[2px] text-base font-light hyphens-auto sm:columns-2">
      Met uitzicht op de Grote Markt van Breda genieten van de lekkerste koffie,
      gezonde lunch en afsluiten met een speciaalbiertje of de perfecte
      cocktail? De Basis heeft het allemaal in huis! Plof neer op onze bank of
