...
export const useDataStore = defineStore('DataStore', {
  state: () => ({
    openingstijden: [
      { dag: 'Maandag', tijd: '11:30 - 02:00' },
      { dag: 'Dinsdag', tijd: '10:30 - 02:00' },
      { dag: 'Woensdag', tijd: '10:30 - 02:00' },
      { dag: 'Donderdag', tijd: '10:30 - 02:00' },
      { dag: 'Vrijdag', tijd: '10:30 - 02:00' },
      { dag: 'Zaterdag', tijd: '10:30 - 02:00' },
      { dag: 'Zondag', tijd: '10:30 - 00:00' }
    ],
    openingstijdenGewijzigd: { datum: 'Vrijdag 15 december 2023' },
